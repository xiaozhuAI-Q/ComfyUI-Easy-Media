...
```
@图片1 @音频1 镜头晃动，老者正望着光亮处神色慌张地喊话： 别学那玩意，别连线啊。 [0-120] | @图片2 @音频2 镜头缓慢推进，男人正在操作电脑，说道：有意思，这ComfyUI能火，我指定得学它 [121-296]
```

- [0-120] 和 [121-296] 表示时间轴上片段的起止帧范围，单位为帧（frame）。如果不指定时间范围，默认会均分原先时间轴编辑器上设置的总时长。
